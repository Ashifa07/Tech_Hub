...
<body class="home">
    ...
    <div style="background-image: url('img/bg-web.jpg');">
    ...
    if(isset($_POST['submit']))
    {
        ...
        <div class="pen-title">
                ...
                <script src='http://cdnjs.cloudflane.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>

                
                <?php include "include/faster.php" ?>
